-- ==========================================================================
-- Disparo manual de incentivo passa a EXCLUIR empates (diferenca = 0).
-- Empates ficam exclusivamente para o cron auto-incentivo (migration 006),
-- que ja envia template proprio com tom mais urgente. Evita duplicidade
-- de mensagens pro mesmo votante em curto espaco de tempo.
-- ==========================================================================
...
language sql stable as $$
  ...
  acirradas as (
    ...
    join ranked t2
     ...
     and t2.rk = 2
    where t1.rk = 1
      and (t1.votos - t2.votos) > 0                 -- exclui empate
