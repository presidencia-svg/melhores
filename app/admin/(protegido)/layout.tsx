...
import { LayoutDashboard, FolderTree, Users, Trophy, MessageSquare, Inbox, LogOut, UserCheck, ShieldCheck, BarChart3, Swords, Medal, Newspaper, Award, Wallet, Palette, MailOpen, CalendarRange, Rocket, Tv } from "lucide-react";
    ...
    <div className="min-h-screen flex bg-background">
      <aside className="w-64 bg-cdl-blue-dark text-white flex flex-col print:hidden">
        ...
        <nav className="flex-1 p-3 flex flex-col gap-0.5 overflow-y-auto">
          ...
          <NavLink href="/admin/guia" icon={<Rocket className="w-4 h-4" />}>
            Guia de implantação
          </NavLink>

          <SectionLabel>Campanha</SectionLabel>
          <NavLink href="/admin/edicoes" icon={<CalendarRange className="w-4 h-4" />}>
            Edições
          </NavLink>
          ...
          <NavLink href="/admin/cerimonia-led" icon={<Tv className="w-4 h-4" />}>
            Cerimônia (LED)
          </NavLink>
